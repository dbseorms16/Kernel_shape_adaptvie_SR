...
class BasicVSRPlusPlus(nn.Module):
    ...
    def __init__(self,
        ...
        if is_low_res_input:
            self.feat_extract = ResidualBlocksWithInputConv(3, mid_channels, 5, ada=ada)
            ...
            self.feat_extract = nn.Sequential(
                ...
                nn.LeakyReLU(negative_slope=0.1, inplace=True),
                ResidualBlocksWithInputConv(mid_channels, mid_channels, 5, ada=ada))
        ...
        for i, module in enumerate(modules):
            ...
            self.backbone[module] = ResidualBlocksWithInputConv(
                (2 + i) * mid_channels, mid_channels, num_blocks, ada=ada)

        # upsampling module
        self.reconstruction = ResidualBlocksWithInputConv(
            5 * mid_channels, mid_channels, 5, ada=ada)
    ...
    def forward(self, lqs):
        ...
        # for i in range(0, t):
        #     torch.save(lqs[:, i, :, :, :].clone().detach(), f'D:/VSR/BasicVSR_PlusPlus-master/results/original_images/{i}.pt')
