...
load_net_1 = torch.load('F:/KAWM/pretrained/New_RCAN/3000_G.pth')
load_net_2 = torch.load('F:/KAWM/pretrained/New_RCAN/6000_G.pth')
# load_net_2 = torch.load('F:\KAWM\pretrained\RCAN/RCAN0240_new.pth')
# load_net_2 = torch.load('./pretrained/HAN/HAN0240.pth')

print(load_net_1.keys())
...
torch.save(new_dict, './pretrained/New_RCAN/merged_RCAN_new.pth')
